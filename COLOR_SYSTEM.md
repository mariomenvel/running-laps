...
| 2026-07-12 | **Modo oscuro desactivado de nuevo tras las pruebas**: visualmente aún no convence — ThemeService vuelve a forzar claro y el selector se retira otra vez de Perfil → Apariencia y de Ajustes de cuenta. La reactivación (d67c2e6) queda en el historial: `git show d67c2e6` restaura ThemeService con persistencia + selector en ambas vistas. Sigue pendiente la pasada visual en oscuro antes del siguiente intento. |
| 2026-07-12 | **Modo oscuro reactivado para pruebas**: ThemeService vuelve a system + persistencia, y el selector Sistema/Claro/Oscuro restaurado en Perfil → Apariencia y en Ajustes de cuenta (retirados en efb94df; reinsertados modernizados: withValues, w600, brandOf). Pendiente: pasada visual en oscuro y caza de usos de `brand` directo como primer plano sin migrar. |
| 2026-07-12 | **`AppColors.brandOf(context)`**: token contextual para brand como primer plano (brandLight en oscuro — 7.3:1 vs 2.5:1 de brand). 99 ternarios ad-hoc migrados en 36 archivos. |
