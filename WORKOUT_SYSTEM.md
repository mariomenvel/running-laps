...
- **Header estándar** (`AppHeader` logo + avatar, sin título ni flecha) + pill "Volver" en el cuerpo, mismo patrón que `training_detail_view.dart`. El footer es propio (botón fijo "GUARDAR SESIÓN"), intencionadamente fuera del `MainShell`.
