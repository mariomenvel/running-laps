...
import '../models/group_stats_model.dart';   // Reusamos GroupMemberStats
import '../models/challenge_models.dart';
import '../models/enums.dart'; // MemberStatus
...
class GroupDetailRepository {
  ...
  Stream<List<Challenge>> getChallengesStream(String groupId) {
    return _db
        .collection('groups')
        .doc(groupId)
