...
class _WorkoutEditorScreenState extends State<WorkoutEditorScreen> {
  ...
  // Tracks whether the user has manually edited the title.
  ...
  void initState() {
    ...
    _titleController.addListener(() {
      _title.value = _titleController.text;
    });
  ...
  Future<void> _onSave() async {
    ...
    // Ensure at least one main block exists for model validity.
    ...
    final session = WorkoutSession(
      ...
      type: resolvedType,
      blocks: blocks,
      scheduledDate: widget.scheduledDate ?? widget.initialSession?.scheduledDate,
