      ...
      messages: [
        OpenRouterChatMessage(
          ...
          content:
              ...
              '   -> localAction: null. Si el mensaje es una pregunta informativa, respondela.'
              '   Si NO es informativa, deja claro que ESTO EN CONCRETO no se puede hacer ahora'
              '   (nunca digas "vale", "hecho", "lo cambio" ni nada que suene a que ya lo vas a aplicar),'
              '   y despues, en frase aparte, menciona que si puede pedir: cambiar el dia de una sesion,'
              '   subir o bajar su intensidad, anadir o quitar series, o eliminarla.'
              ' REGLA DE CONSISTENCIA (critica): response y intent SIEMPRE deben coincidir.'
              '   Si intent es "unsupported", response NUNCA puede sonar a que la accion se va a realizar'
              '   o ya se realizo — el usuario vera un mensaje que dice que si pero no tendra forma de aplicarlo.'
              '   Si response confirma una accion concreta (mover, cancelar, completar, subir/bajar intensidad,'
              '   anadir/quitar series), intent DEBE ser el intent correspondiente, nunca "unsupported".'
