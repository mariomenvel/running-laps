...
class ContinuousStatsCard extends StatelessWidget {
  final ContinuousStats stats;
  final Color accentColor;

  const ContinuousStatsCard({
    super.key,
    required this.stats,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _row(context, Icons.timer_outlined, 'Tiempo total',
          ...
          if (stats.percentInTargetZone != null) ...[
            const SizedBox(height: 12),
            _row(context, Icons.center_focus_strong_rounded, 'En zona objetivo',
                '${stats.percentInTargetZone!.toStringAsFixed(0)}%',
                valueColor: stats.percentInTargetZone! >= 70
                    ? AppColors.rpeLow
                    : AppColors.rpeMid),
          ],
        ],
